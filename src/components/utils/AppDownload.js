...
export default function AppDownload() {
  ...
  return (
    <div className={classes.root}>
      <div className="intro">
        <div>
          <h1 style={{ margin: 0 }}>NoteStory</h1>
          {/* <p style={{ margin: 0 }}>开启记录你的故事(精彩)</p> */}
          <p style={{ margin: 0 }}>开启你的记录</p>
        </div>
        <img src={logo} />
      </div>
      <div>
        <a
          className={classes.downloadHref}
          href="http://download.wesy.club"
          target="_blank"
        ...
        {/* <a className={classes.downloadHref} href="/download/notestory/mac">
          <AppleIcon />
          <span>Mac 下载</span>
        </a>
        {/* <a
          className={classes.downloadHref}
          href="/download/notestory/liunx?release=Ubuntu"
        >
          <LiunxIcon />
          <span>Liunx 下载</span>
        </a> */}
        {/* <a className={classes.downloadHref} href="/download/notestory/linux">
          <LiunxIcon />
          <span>Liunx 下载</span>
        </a> */}
      </div>
